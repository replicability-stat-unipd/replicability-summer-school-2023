...
The meta-analysis by @Oliveira2023-yf is about the efficacy of Internet-delivered cognitive behavioral therapy (ICBT) interventions in reducing anxiethy among university students. They collected $k = 15$ studies with a total of 1619 participants and summarised the effect using a standardized mean difference. The dataset is `02-meta-analysis/objects/oliveira2023_clean.rds`.
...
The dataset can be found in `02-meta-analysis/objects/dear2019_clean.rds`:

```{r}
#| echo: false
dear2019 <- readRDS(here("02-meta-analysis/objects/dear2019_clean.rds"))
```
