...
dados <- escalc(measure = "SMD", n1i = n.exp.pos, n2i = n.control.pos, m1i = mean.exp.pos, m2i = mean.control.pos, sd1i = sd.exp.pos, sd2i = sd.control.pos, data = final_database, slab=paste(Study, Year, sep=", "))

saveRDS(dados, "02-meta-analysis/objects/oliveira2023_clean.rds")
save(dados, file = "data/oliveira2023.rda")