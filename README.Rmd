...
lect <- data.frame(
  stringsAsFactors = FALSE,
              Date = c("09-18-2023", "09-19-2023"),
           Speaker = c("Prof. Branden Fitelson", "Prof. Branden Fitelson"),
             Title = c("Philosophical and statistical bases of replicability",
                       "Philosophical and statistical bases of replicability"),
              File = c("lectures/fitelson.pdf", "lectures/fitelson.pdf")
)

lect$Title <- sprintf('<a href="%s">%s</a>', lect$File, lect$Title)
