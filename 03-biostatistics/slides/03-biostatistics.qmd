...
- the **suboptimal** state is coded as 0 i.e. not having the *disease*
- the **optimal** state is coded as 1 i.e. having the *disease*
...
1. Load and explore the data (you can the `ovarianclean.rds` or using the raw `curatedOvarianData`)
